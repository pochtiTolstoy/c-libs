#ifndef MEMCMP_DATA_H
#define MEMCMP_DATA_H
...
const s21_size_t size_ar1 = sizeof(array1) / sizeof(array1[0]);
const s21_size_t size_ar2 = sizeof(array2) / sizeof(array2[0]);
const s21_size_t size_ar3 = sizeof(array3) / sizeof(array2[0]);
